...
public class VisualizerDataModel {
    ...
    void setSelectedSegmentModels(List<SegmentModel> newModels) {
        List<SegmentModel> oldTables = this.selectedSegmentModels;
        this.selectedSegmentModels = newModels;
        pcs.firePropertyChange(PROP_SELECTED_SEGMENT_MODELS, oldTables, newModels);
    }
    ...
    void setSedStarTables(List<IrisStarTable> newTables) {
        ...
        pcs.firePropertyChange(PROP_SELECTED_TABLES, oldTables, sedStarTables);
    }
