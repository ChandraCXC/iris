...
public class UnitsWidget extends javax.swing.JPanel {
    ...
    private static final List<String> xUnitsList = new ArrayList<>();
    private static final List<String> yUnitsList = new ArrayList<>();
    
    static {
        for (XUnit unit : XUnit.values()) {
            xUnitsList.add(unit.getString());
        }
        for (SPVYUnit unit : SPVYUnit.values()) {
            yUnitsList.add(unit.getString());
        }
    }
    ...
    /*
     *
     * For databinding to the list models.
     *
     */
    public List<String> getXUnitsList() {
        return Collections.unmodifiableList(this.xUnitsList);
    }
    
    public List<String> getYUnitsList() {
        return Collections.unmodifiableList(this.yUnitsList);
    }
