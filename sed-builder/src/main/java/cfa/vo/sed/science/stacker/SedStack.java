...
//     *
//     * @param sedBuilderStack
//     *            new value of sedBuilderStack
//     */
...
//    }
            ...
            UnitsException 
    {
        ...
        seds.add(nsed);
        origSeds.add(sed);
        // Segment seg = ExtSed.flatten(sed, sed.getSegment(0).getFluxAxisUnits()).getSegment(0);
...
//                seg = ExtSed
//                        .flatten(sed0,
//                                sed0.getSegment(0).getSpectralAxisUnits(),
//                                sed0.getSegment(0).getFluxAxisUnits())
//                        .getSegment(0);
//                nsed.addSegment(seg);
...
//            seg.setDataValues(
//                    (double[]) nsed.getSegment(0)
//                            .getDataValues(SEDMultiSegmentSpectrum.E_UTYPE),
