...
public class Iris extends Application implements IrisApplication {
    ...
    private static final Logger logger = Logger.getLogger(Iris.class.getName());
    private static final long CONNECTION_RETRY_MILLIS = 1000;
    private boolean SAMP_ENABLED = !System.getProperty("samp", "true").toLowerCase().equals("false");
    ...
    public static final class HubSAMPController extends SAMPController {
        ...
        private class CheckConnectionTask extends TimerTask {
            ...
            private void checkSherpaStatusUpdate() {
                sherpaState = SherpaClient.ping(Iris.HubSAMPController.this);
