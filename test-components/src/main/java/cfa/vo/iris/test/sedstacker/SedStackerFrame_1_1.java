 ...
 * @author jbudynk
 */
public class SedStackerFrame_1_1 extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
                    ...
                    .add(jPanel6Layout.createSequentialGroup()
                        .add(jPanel6Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            .add(jPanel6Layout.createSequentialGroup()
                                ...
                                .add(jComboBox6, 0, 1, Short.MAX_VALUE))
                            .add(jPanel6Layout.createSequentialGroup()
                                .add(jLabel9)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(jTextField7))
                            .add(jPanel6Layout.createSequentialGroup()
                                .add(jLabel7)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(jComboBox5, 0, 1, Short.MAX_VALUE)))
                        .addContainerGap())
                    .add(jPanel6Layout.createSequentialGroup()
                        .add(jPanel6Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            .add(jPanel6Layout.createSequentialGroup()
        ...
        jTabbedPane1.addTab("Redshift", jPanel2);
        ...
        jTabbedPane1.addTab("Normalize", jPanel3);
